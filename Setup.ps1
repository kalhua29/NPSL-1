...
Write-Form ( Invoke-WebRequest -Uri $License ).Content "Please Read the Software License"
Write-Form ( Invoke-WebRequest -Uri $3rdPartyLicense ).Content "Please Read the 3rd Party Software Licenses"
